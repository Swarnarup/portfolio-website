...
const Navbar = () => {
  ...
  return (
    <motion.nav initial={{opacity:0, y:-50}} animate={{opacity:1, y:0}} className="fixed mx-auto border border-[#33353F] top-0 left-0 right-0 z-10 bg-black bg-opacity-100 z-40">
